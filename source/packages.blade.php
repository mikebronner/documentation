...
<section class="container max-w-2xl mx-auto px-6 py-10 md:py-12">
    ...
    <div class="p-2 w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
        ...
        >
            <img
                class="w-full"
                src="https://user-images.githubusercontent.com/1791050/66706715-21cc0800-eceb-11e9-90b4-0a6ae3dd97b7.png"
    ...
    <div class="p-2 w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
        ...
        >
            <img
                class="w-full"
                src="https://user-images.githubusercontent.com/1791050/66761837-a9378980-ee59-11e9-9ddf-0293e0eb344b.png"
    ...
    <div class="p-2 w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
        ...
        >
            <img
                class="w-full"
                src="https://cloud.githubusercontent.com/assets/1791050/18258832/b7c177d6-7391-11e6-99ba-ea7e63735cd8.jpg"
    ...
    <div class="p-2 w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
        ...
        >
            <img
                class="w-full"
                src="https://user-images.githubusercontent.com/1791050/30284899-2fcd34be-96d1-11e7-8ded-c41b7e9f5879.jpg"
    ...
    <div class="p-2 w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
        ...
        >
            <img
                class="w-full"
                src="https://user-images.githubusercontent.com/1791050/59978378-86beef00-9590-11e9-9a10-dee8f77f0037.png"
    ...
    <div class="p-2 w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
        ...
        >
            <img
                class="w-full"
                src="https://user-images.githubusercontent.com/1791050/59730775-7efdf400-91f8-11e9-90f4-cd85866be75f.png"
