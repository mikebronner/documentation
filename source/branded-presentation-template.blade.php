...
@section('content')
    <section class="container mx-auto max-w-2xl">
        ...
        <p>
            ...
            appear more professional, and be focussed on earning money, rather
        ...
        <p>
            ...
            Order your template here. The pricing is between $400 and $1200,
            depending on the package you choose. Professional templates show
            that you are serious about your business, and the cost is easily
            recouped through increased business and/or higher fees.
        </p>
        <button
